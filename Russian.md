...
- **2021 - настоящее время: Старший iOS-разработчик, [Yandex](https://bank.yandex.ru), Москва**
	...
	- Создание экрана и логики входа по пин-коду
	- Интеграция получения и обработки пуш-уведомлений
	- Разработка механизма обработки диплинков
	- Внедрение поддержки темной темы
	- Внедрение DI на [Needle](https://github.com/uber/needle)
	- Проведение код-ревью
	- Организация регулярных встреч для обсуждения технического развития iOS-проекта
...
- **2021 - 2021 (1 год): iOS инженер, [Avito](https://www.avito.ru), Москва**
	...
	- Поддержка организации регулярных встреч iOS-комьюнити
